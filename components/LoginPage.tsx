...
import {
  ArrowRight, Youtube, Globe, Loader2,
} from "lucide-react";
    ...
    <div className="flex flex-col md:flex-row h-screen bg-background overflow-hidden relative">
      ...
      <div className="w-full md:w-[300px] shrink-0 flex flex-col bg-[var(--surface-0)] border-b md:border-b-0 md:border-r border-border px-6 py-6 md:px-8 md:py-10 relative z-10">
        ...
        <div className="hidden md:block mb-11">
          <div className="text-[9.5px] font-bold tracking-[0.12em] uppercase text-[var(--text-dim)] mb-[10px]">Welcome Back</div>
        ...
        <div className="hidden md:flex flex-col items-center justify-center flex-1 opacity-60">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/20 to-[var(--neon-purple)]/20 flex items-center justify-center border border-primary/10 mb-4">
            <Globe size={32} className="text-primary" />
          </div>
          <p className="text-[11px] text-[var(--text-dim)] text-center leading-relaxed max-w-[180px]">
            Access your AI-powered YouTube growth toolkit
          </p>
        </div>
        ...
        <div className="w-full max-w-[480px]">
          <MotionDiv initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }}>
            ...
            <div className="text-center text-sm text-[var(--text-dim)]">
              ...
              <button onClick={() => navigate.push("/signup")} className="bg-transparent border-none p-0 cursor-pointer text-[var(--foreground)] font-semibold hover:underline">
                Sign up
              </button>
            </div>
